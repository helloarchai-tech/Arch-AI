...
def build_chat_with_context_prompt(
    ...
    return (
        ...
        f"INSTRUCTIONS:\n"
        f"1. Treat this as a project-specific architecture Q&A.\n"
        f"2. If user mentions a generic tech term (e.g., nginx, load balancer, gateway, cache, auth), map it to the closest listed component and answer in project context.\n"
